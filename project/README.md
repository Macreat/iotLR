...
![WeatherShield](./raspiProcess/source/docs/demo.png)
...
Desarrollada en el marco del curso **Design iOt Systems**, guiado por el **Prof. Gustavo Adolfo Osorio (UNAL 2025-2)**.
...
![supervision](https://img.shields.io/badge/Supervisor-Gustavo%20Adolfo%20Osorio-orange)
...
WeatherShield es una **plataforma IoT embebida** basada en **Linux** que combina:
...
- **espCode** → [`ESP32`](espStationMode/station/)

- **MqttCnf** → [`MQTT`](IoT_MQTT_SERVER/MQTT_SERVER/)

- **RaspiProcess** → [`RASPI`](raspiProcess/source/)
...
![WeatherShield](./raspiProcess/source/diagrams/software.jpg)

#### Hardware

![WeatherShield](./raspiProcess/source/diagrams/hardware.jpg)

#### Communication

![WeatherShield](./raspiProcess/source/diagrams/communicationProtocol.png)
...
- **requirements** → [`requirements `](./raspiProcess/source/docs/requirements/)
- **hardware** → [`BOM`](./raspiProcess/source/hardware/bom.md)
- **software** → [`software`](./raspiProcess/source/software)
...
Curso: _iOt system design_ – 2025-2
